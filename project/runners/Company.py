...
async def main(args):
    ...
    try:
        ...
        # company_schema_name = "employee id schema"
        # company_schema_attrs = ["employee_id", "name", "date", "position"]
        ...
        async for option in prompt_loop(options):
            ...
            """
            if option == "1":
                cred_def_id = await prompt("Credential definition from the school expected: ")
                ...
                # this sends the request to our agent, which forwards it to Student
...
if __name__ == "__main__":
    parser = arg_parser(ident="company", port=8040)
