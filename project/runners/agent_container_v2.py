...
def arg_parser(ident: str = None, port: int = 8020):
    ...
    "ident", if specified, refers to one of the standard demo personas - Student, TSP or Company.
    """
    ...
    if (not ident) or (ident != "student"):
        parser.add_argument(
            ...
            action="store_true",
            help=(
                "Reuse connections by using tsp public key in the invite. "
...
async def create_agent_with_args(args, ident: str = None):
    ...
    agent = AgentContainer(
        ...
        seed="00000000000000000000000000001234" if public_did else None,
        arg_file=arg_file,
        aip=aip,
...
async def test_main(
    ...
    try:
        ...
        # start the agents - tsp gets a public DID and schema/cred def
        await tsp_container.initialize(
        ...
        # tsp create invitation
        invite = await tsp_container.generate_invitation()
        ...
        # wait for tsp connection to activate
        await tsp_container.detect_connection()
        await student_container.detect_connection()

        # TODO tsp issue credential to student
        # TODO student check for received credential
        ...
        try:
            ...
            if tsp_container:
                log_msg("Shutting down tsp agent ...")
                await tsp_container.terminate()
        except Exception as e:
